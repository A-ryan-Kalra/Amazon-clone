...
function Main({
  ...
  return (
    <div className="">
      <div className="flex w-[1550px] bg-white mx-auto flex-col mb-2">
        <div className=" gap-4 pt-5 flex w-full  translate-x-3 ">
          <div className=" shadow-2xl justify-center relative  flex-col w-[25%] bg-[#FFFFFF]    ">
            <h2 className="p-1 font-bold text-xl text-center m-1">
              Handsets for your loved ones | Family | Friends
            </h2>
            <div className="grid grid-cols-2   ">
              {products.products?.map((data) => (
                <Products key={data.id} products={data} />
              ))}
            </div>
            <a
              href="#"
          ...
          <div className="shadow-2xl justify-center  flex-col w-[25%] bg-[#FFFFFF]">
            ...
            <div className="grid grid-cols-2 p-2">
              {furniture.products?.map((data) => (
                <Products products={data} key={data.id} />
              ))}
